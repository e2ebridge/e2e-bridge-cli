...
function helpText(message) {
    ...
    help +=
        ...
        'resources [[-d|--delete ${ResourceName}]|[--upload ${FilePath}]] [settings]\n' +
        'java-resources [[-d|--delete ${ResourceName}]|[--upload ${FilePath}]] [settings]\n' +
        'xslt-resources [[-d|--delete ${ResourceName}]|[--upload ${FilePath}]] [settings]\n' +
        'variables [settings]\n' +
...
module.exports.processOperation = function(positionalArguments) {
    ...
    return {error, operation, settings, requiredProperties};
};
...
module.exports.getOutputFormatters = function(options){
    return Object.assign({}, fmt.default);
};