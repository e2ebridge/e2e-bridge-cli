...
function helpText(message) {
    ...
    help +=
        ...
        'resources [[-x|--xslt]|[-j|--java]] [settings]\n' +
...
module.exports.perform = function(options, callback){
    ...
    switch(options.operation){
        ...
        case operations.RESOURCES:
            if(options.xslt) {
                bridgeInstance.listXUMLXsltResources(callback);
            } else if(options.java) {
                bridgeInstance.listXUMLJavaResources(callback);
            } else {
                bridgeInstance.listXUMLResourceResources(callback);
            }
            return null;
